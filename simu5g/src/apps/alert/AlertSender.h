...
class AlertSender : public omnetpp::cSimpleModule, protected omnetpp::cListener
{
  ...
  protected:
    ...
    void receiveSignal(cComponent *source, omnetpp::simsignal_t signalID, cObject* obj, cObject *details) override;
