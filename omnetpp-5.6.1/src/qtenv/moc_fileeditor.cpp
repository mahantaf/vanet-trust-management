...
const QMetaObject omnetpp::qtenv::FileEditor::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_omnetpp__qtenv__FileEditor.data,
      qt_meta_data_omnetpp__qtenv__FileEditor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
