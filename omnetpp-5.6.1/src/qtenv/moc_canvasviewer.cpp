...
void omnetpp::qtenv::CanvasViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CanvasViewer *_t = static_cast<CanvasViewer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CanvasViewer::*_t)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CanvasViewer::click)) {
                *result = 0;
            }
        }
        {
            typedef void (CanvasViewer::*_t)(QContextMenuEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CanvasViewer::contextMenuRequested)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject omnetpp::qtenv::CanvasViewer::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_omnetpp__qtenv__CanvasViewer.data,
      qt_meta_data_omnetpp__qtenv__CanvasViewer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *omnetpp::qtenv::CanvasViewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_omnetpp__qtenv__CanvasViewer.stringdata0))
        return static_cast<void*>(const_cast< CanvasViewer*>(this));
