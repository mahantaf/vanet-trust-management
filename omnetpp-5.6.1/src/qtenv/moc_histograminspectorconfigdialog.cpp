...
void omnetpp::qtenv::HistogramInspectorConfigDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        HistogramInspectorConfigDialog *_t = static_cast<HistogramInspectorConfigDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (HistogramInspectorConfigDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HistogramInspectorConfigDialog::applyButtonClicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject omnetpp::qtenv::HistogramInspectorConfigDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_omnetpp__qtenv__HistogramInspectorConfigDialog.data,
      qt_meta_data_omnetpp__qtenv__HistogramInspectorConfigDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *omnetpp::qtenv::HistogramInspectorConfigDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_omnetpp__qtenv__HistogramInspectorConfigDialog.stringdata0))
        return static_cast<void*>(const_cast< HistogramInspectorConfigDialog*>(this));
