...
const QMetaObject omnetpp::qtenv::ObjectListView::staticMetaObject = {
    { &QTableView::staticMetaObject, qt_meta_stringdata_omnetpp__qtenv__ObjectListView.data,
      qt_meta_data_omnetpp__qtenv__ObjectListView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *omnetpp::qtenv::ObjectListView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_omnetpp__qtenv__ObjectListView.stringdata0))
        return static_cast<void*>(const_cast< ObjectListView*>(this));
