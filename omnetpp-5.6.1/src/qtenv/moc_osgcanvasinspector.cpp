...
const QMetaObject omnetpp::qtenv::OsgCanvasInspector::staticMetaObject = {
    { &Inspector::staticMetaObject, qt_meta_stringdata_omnetpp__qtenv__OsgCanvasInspector.data,
      qt_meta_data_omnetpp__qtenv__OsgCanvasInspector,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *omnetpp::qtenv::OsgCanvasInspector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_omnetpp__qtenv__OsgCanvasInspector.stringdata0))
        return static_cast<void*>(const_cast< OsgCanvasInspector*>(this));
