...
void omnetpp::qtenv::MessagePrinterTagsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MessagePrinterTagsDialog *_t = static_cast<MessagePrinterTagsDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject omnetpp::qtenv::MessagePrinterTagsDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_omnetpp__qtenv__MessagePrinterTagsDialog.data,
      qt_meta_data_omnetpp__qtenv__MessagePrinterTagsDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *omnetpp::qtenv::MessagePrinterTagsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_omnetpp__qtenv__MessagePrinterTagsDialog.stringdata0))
        return static_cast<void*>(const_cast< MessagePrinterTagsDialog*>(this));
