...
const QMetaObject omnetpp::qtenv::CompoundModuleItem::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_omnetpp__qtenv__CompoundModuleItem.data,
      qt_meta_data_omnetpp__qtenv__CompoundModuleItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *omnetpp::qtenv::CompoundModuleItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_omnetpp__qtenv__CompoundModuleItem.stringdata0))
        return static_cast<void*>(const_cast< CompoundModuleItem*>(this));
